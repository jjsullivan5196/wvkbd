...
static struct key keys_anihortes[], keys_index[], keys_numpad[];
...
static struct key key_anihortes_settings_north      = {"", "", 1.0, Command, IncreaseHeight, 0, DecrecaseHeight, .scheme = 5};
...
static struct key key_anihortes_settings_south      = {"", "", 1.0, Command, DecrecaseHeight, 0, IncreaseHeight, .scheme = 5};
