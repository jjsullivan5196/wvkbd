...
static const char keymap_polish[] = "xkb_keymap {\
        xkb_keycodes \"(unnamed)\" {\
                minimum = 8;\
                maximum = 255;\
                <ESC>                = 9;\
        ...
        \
                ...
                key <AC03>               {	[               d,               D, eogonek,    Eogonek ] };\
                key <AC04>               {	[               f,               F, colon,      underscore ] };\
                key <AC05>               {	[               g,               G, semicolon,  apostrophe ] };\
                key <AC06>               {	[               h,               H, parenleft,  braceleft ] };\
                key <AC07>               {	[               j,               J, parenright, braceright ] };\
                key <AC08>               {	[               k,               K, oacute,     Oacute ] };\
                ...
                key <AB04>               {	[               v,               V, U2013,     dollar ] };\
                key <AB05>               {	[               b,               B, question,  EuroSign ] };\
                key <AB06>               {	[               n,               N, exclam,    numbersign ] };\
                key <AB07>               {	[               m,               M, U201E,     guillemotright ] };\
                key <AB08>               {	[           comma,            less, U201D,     guillemotleft] };\
                key <AB09>               {	[          period,         greater, bar,       ellipsis ] };\
                key <AB10>               {	[           slash,        question ] };\
                key <RTSH>               {	[         Shift_R ] };\
                key <KPMU>               {\
                        type= \"CTRL+ALT\",\
